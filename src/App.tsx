  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 selection:bg-orange-500 selection:text-black">
      ...
      <section className="h-auto min-h-screen pt-20 sm:pt-16 flex items-center px-4 sm:px-6 lg:px-16 bg-gray-900 relative overflow-hidden border-b border-gray-800/50">
        <div className="absolute right-0 bottom-0 top-auto translate-y-0 md:top-1/2 md:-translate-y-1/2 w-full h-[70%] md:w-[90%] md:h-[140%] bg-[radial-gradient(circle_at_bottom,_var(--tw-gradient-stops))] md:bg-[radial-gradient(circle_at_right,_var(--tw-gradient-stops))] from-orange-500/85 via-gray-900/95 to-transparent opacity-90 pointer-events-none" />
