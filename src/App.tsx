...
function App() {
  ...
  return (
    ...
    {/* Hero Section */}
    <section className="h-auto min-h-screen pt-20 sm:pt-16 flex items-center px-4 sm:px-6 lg:px-16 bg-gradient-to-br from-gray-900 via-gray-800 to-orange-700">
